  ...
  theme: {
    ...
    extend: {
      ...
      boxShadow: {
        ...
        "sm-wellness": "0 4px 12px rgba(0, 0, 0, 0.06)",
        "md-wellness": "0 8px 24px rgba(0, 0, 0, 0.08)",
      },
      backgroundImage: {
        "gradient-wellness": "linear-gradient(135deg, hsl(var(--wellness-50)) 0%, hsl(var(--wellness-100)) 100%)",
      },
    },
  },
